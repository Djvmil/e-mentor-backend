...
import org.djvmil.em.backend.security.errors.ApiErrorResponse;
import org.djvmil.em.backend.security.exceptions.AccessDeniedException;
import org.djvmil.em.backend.security.old.EMUserDetailsServiceOld;
...
public class JwtAuthFilter extends OncePerRequestFilter {
    ...
    private final EMUserDetailsServiceOld userDetailsService;
    private final ObjectMapper objectMapper;

    public JwtAuthFilter(EMUserDetailsServiceOld userDetailsService, ObjectMapper objectMapper) {
